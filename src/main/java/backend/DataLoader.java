...
public class DataLoader implements ApplicationRunner {
    ...
    private static final String IMG_BASE = "https://pub-ff62bf51a3fa432ab455c83ccd93e3a1.r2.dev/usuarios/";
    ...
    public void run(ApplicationArguments args) {
        ...
        Usuario admin = usuario("Administrador PetGO", "000.000.000-00", "01/01/1990",
                "01310-100", "Av. Paulista", "1000", "admin@petgo.com", "Admin@123", 1, null, null, null);

        // ===================== FUNCIONÁRIOS =====================
        Usuario vet = usuario("Carlos Eduardo Souza", "110.345.678-45", "15/03/1988",
                null, null, null, "carlos.vet@petgo.com", "Func@123", 3, "Veterinário", "(11) 99111-1111",
                IMG_BASE + "vet.jpg");

        Usuario esteticista1 = usuario("Fernanda Lima", "224.567.890-75", "22/07/1995",
        ...
        Usuario esteticista2 = usuario("Ricardo Alves", "333.333.333-33", "10/11/1992",
                null, null, null, "ricardo.est@petgo.com", "Func@123", 3, "Esteticista", "(11) 99333-3333", null);

        Usuario atendente = usuario("Juliana Martins", "444.444.444-44", "05/06/1997",
                null, null, null, "juliana.at@petgo.com", "Func@123", 3, "Atendente", "(11) 99444-4444", null);

        // ===================== CLIENTES =====================
        Usuario ana = usuario("Ana Paula Ferreira", "338.912.456-02", "14/02/1990",
        ...
        Usuario joao = usuario("João Vitor Santos", "666.666.666-66", "30/08/1985",
                "01401-000", "Rua Augusta", "800", "joao.vitor@email.com", "Cliente@123", 2, null, "(11) 97602-2002", null);

        Usuario mariana = usuario("Mariana Costa", "777.777.777-77", "19/12/1998",
                "05001-100", "Av. Rebouças", "3970", "mariana.costa@email.com", "Cliente@123", 2, null, "(11) 96703-3003", null);

        Usuario pedro = usuario("Pedro Henrique Gomes", "888.888.888-88", "07/04/1993",
                "02010-000", "Rua do Triunfo", "45", "pedro.gomes@email.com", "Cliente@123", 2, null, "(11) 95804-4004", null);

        Usuario lucia = usuario("Lúcia Oliveira Nunes", "999.999.999-99", "25/09/1975",
                "03101-000", "Av. Rangel Pestana", "220", "lucia.nunes@email.com", "Cliente@123", 2, null, "(11) 94905-5005", null);

        Usuario rafael = usuario("Rafael Mendes Carvalho", "101.010.101-01", "12/05/1994",
                "01310-200", "Av. Paulista", "500", "rafael.mendes@email.com", "Cliente@123", 2, null, "(11) 93106-6006", null);

        Usuario camila = usuario("Camila Torres Braga", "202.020.202-02", "08/11/1996",
                "04551-060", "Rua Leopoldo Couto", "308", "camila.torres@email.com", "Cliente@123", 2, null, "(11) 92207-7007", null);

        Usuario felipe = usuario("Felipe Rocha Andrade", "303.030.303-03", "21/03/1988",
                "05424-020", "Av. Sumaré", "1420", "felipe.rocha@email.com", "Cliente@123", 2, null, "(11) 91308-8008", null);

        Usuario beatriz = usuario("Beatriz Nascimento Silva", "404.040.404-04", "03/07/2000",
                "09520-070", "Rua Marechal Deodoro", "77", "beatriz.nasc@email.com", "Cliente@123", 2, null, "(11) 98409-9009", null);

        Usuario gustavo = usuario("Gustavo Lima Pereira", "505.050.505-05", "17/09/1991",
                "01414-001", "Rua Oscar Freire", "900", "gustavo.lima@email.com", "Cliente@123", 2, null, "(11) 97510-0010", null);

        Usuario isabela = usuario("Isabela Rodrigues Pinto", "606.060.606-06", "29/01/1997",
                "04571-010", "Rua das Olimpíadas", "200", "isabela.rod@email.com", "Cliente@123", 2, null, "(11) 96611-1011", null);

        Usuario thiago = usuario("Thiago Barbosa Correia", "707.070.707-07", "14/06/1983",
                "01244-020", "Rua Consolação", "2300", "thiago.barb@email.com", "Cliente@123", 2, null, "(11) 95712-2012", null);

        Usuario natalia = usuario("Natália Souza Freitas", "808.080.808-08", "05/10/1999",
                "03303-000", "Av. Celso Garcia", "850", "natalia.souza@email.com", "Cliente@123", 2, null, "(11) 94813-3013", null);

        Usuario lucas = usuario("Lucas Ferreira Matos", "909.090.909-09", "22/04/1995",
                "05009-000", "Rua Cardoso de Almeida", "1100", "lucas.ferreira@email.com", "Cliente@123", 2, null, "(11) 93914-4014", null);

        Usuario juliana = usuario("Juliana Pires Vieira", "110.110.110-10", "11/12/1992",
                "04711-130", "Av. João Dias", "640", "juliana.pires@email.com", "Cliente@123", 2, null, "(11) 92015-5015", null);

        Usuario marcos = usuario("Marcos Antônio Ribeiro", "220.220.220-20", "28/02/1980",
                "03047-000", "Rua do Gasômetro", "400", "marcos.ribeiro@email.com", "Cliente@123", 2, null, "(11) 91116-6016", null);

        Usuario carolina = usuario("Carolina Duarte Monteiro", "330.330.330-30", "16/08/2001",
                "05305-902", "Rua Butantã", "370", "carolina.duarte@email.com", "Cliente@123", 2, null, "(11) 98217-7017", null);

        // ===================== PETS =====================
        Pet mel      = pet("Mel",      "Golden Retriever", "Grande",  "Fêmea", "14/02/2023", "Dócil, adora banho",                     ana.getId(),     IMG_BASE + "mel.jpg");
        Pet bolinha  = pet("Bolinha",  "Poodle",           "Pequeno", "Macho", "14/02/2025", "Muito agitado",                          ana.getId(),     IMG_BASE + "bolinha.jpg");
        Pet thor     = pet("Thor",     "Rottweiler",       "Grande",  "Macho", "30/08/2020", "Precisa de focinheira durante tosa",      joao.getId(),    null);
        Pet luna     = pet("Luna",     "Shih Tzu",         "Pequeno", "Fêmea", "19/12/2023", "Pelo longo, tosa a cada 45 dias",        mariana.getId(), null);
        Pet simba    = pet("Simba",    "Persa",            "Pequeno", "Macho", "19/12/2021", "Gato, muito tranquilo",                  mariana.getId(), null);
        Pet bob      = pet("Bob",      "Labrador",         "Grande",  "Macho", "07/04/2020", "Alérgico a shampoo com fragrância",      pedro.getId(),   null);
        Pet nina     = pet("Nina",     "Dachshund",        "Pequeno", "Fêmea", "25/09/2018", "Coluna sensível, cuidado ao segurar",    lucia.getId(),   null);
        Pet rex      = pet("Rex",      "Pastor Alemão",    "Grande",  "Macho", "10/11/2021", "Só tosa higiênica",                     lucia.getId(),   null);
        Pet pipoca   = pet("Pipoca",   "Maltês",           "Pequeno", "Fêmea", "08/11/2023", "Pelo branco, usar shampoo clareador",    rafael.getId(),  null);
        Pet cookie   = pet("Cookie",   "Beagle",           "Médio",   "Fêmea", "08/11/2022", "Ativa e brincalhona",                   camila.getId(),  null);
        Pet zeus     = pet("Zeus",     "Husky Siberiano",  "Grande",  "Macho", "21/03/2024", "Pelagem densa, demora mais para secar",  felipe.getId(),  null);
        Pet mia      = pet("Mia",      "Siamês",           "Pequeno", "Fêmea", "03/07/2020", "Gata, comportamento agitado no banho",  beatriz.getId(), null);
        Pet caramelo = pet("Caramelo", "SRD",              "Médio",   "Macho", "17/09/2021", "Resgatado, muito dócil",                gustavo.getId(), null);
        Pet nala     = pet("Nala",     "Border Collie",    "Grande",  "Fêmea", "29/01/2025", "Filhote, primeira vez no pet shop",     isabela.getId(), null);
        Pet frida    = pet("Frida",    "Yorkshire",        "Pequeno", "Fêmea", "14/06/2019", "Tosa a cada 30 dias",                   thiago.getId(),  null);
        Pet apolo    = pet("Apolo",    "Dálmata",          "Grande",  "Macho", "05/10/2022", "Ansioso, fica agitado com barulho",     natalia.getId(), null);
        Pet lola     = pet("Lola",     "Spitz Alemão",     "Pequeno", "Fêmea", "22/04/2024", "Muito peluda, desembolamento frequente", lucas.getId(),  null);
        Pet duke     = pet("Duke",     "Boxer",            "Grande",  "Macho", "11/12/2020", "Focinheiro largo, cuidado na tosa",     juliana.getId(), null);
        Pet amendoim = pet("Amendoim", "Lhasa Apso",       "Pequeno", "Macho", "28/02/2018", "Idoso, cuidado extra no manuseio",      marcos.getId(),  null);
        Pet aurora   = pet("Aurora",   "Golden Retriever", "Grande",  "Fêmea", "16/05/2025", "Filhote, super agitada",                carolina.getId(),null);
    ...
    private Usuario usuario(String nome, String cpf, String dataNascimento,
        ...
        u.setImagemUrl(imagemUrl);
        return usuarioRepository.save(u);
    }

    private Pet pet(String nome, String raca, String porte, String sexo, String dataNascimento,
                    String observacao, Integer usuarioId, String imagemUrl) {
        Pet p = new Pet();
        p.setNome(nome);
        p.setRaca(raca);
        p.setPorte(porte);
